        ...
        <tr>
          ...
          <td width="261" className="xx10">
            <div style={{ height: 66, overflow: 'hidden' }}>
              ...
              <br />
              {data.receiverData.province} {data.receiverData.city} {data.receiverData.region}{' '}
        ...
        <tr>
          ...
          <td width="261" className="xx14">
            <div style={{ height: 44, overflow: 'hidden' }}>
              ...
              <br />
              {data.senderData.province} {data.senderData.city} {data.senderData.region}{' '}
              {data.senderData.address}
            </div>
          </td>
        </tr>
      </tbody>
            ...
            <table className="no_border">
              <tbody>
                <tr>
                  ...
                  <td style={{ verticalAlign: 'middle', padding: 0 }} height="55">
                    &nbsp;
                  </td>
                  <td
                    style={{ verticalAlign: 'middle', padding: 0, textAlign: 'center' }}
                    height="55"
                    width="257"
                  >
                    <Barcode
                ...
                <tr>
                  <td height="90%" width="370" className="xx10">
                    <div className="f8" style={{ fontWeight: 'normal' }}>
                      数量：{data.quantity}&nbsp;&nbsp;重量：{data.weight}
                      &nbsp;&nbsp;星月童书书本回收
                    </div>
                  </td>
                </tr>
                <tr>
                  <td style={{ padding: 0 }} width="370" className="xx18">
                    已检视
                  </td>
                </tr>
              </tbody>
